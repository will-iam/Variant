...
for data in sizeDataDict:
    for key, value in data.items():
        ...
        for run in value:
            ...
            # Select only pure SDD, no hybrid.
            if R > 64 and nSDD != R:
                continue
            ...
            # Select only pure SDS, no hybrid.
            if R == 64 and nSDD > 1:
                continue
...
for r in loopTimeDict:
    ...
    ax.plot(xArray, totalTimeArray, '-', label="Loop Time %s" % (r // 64))
