...
int Hydro8x1::init() {
    ...
    _domain->buildSubDomainsMPI(8, 1);
    ...
    _domain->addEquation("updateBoundary", std::bind(&Hydro8x1::updateBoundary, this,
                                   std::placeholders::_1, std::placeholders::_2));
    return 0;
}
...
void Hydro8x1::updateBoundary(const SDShared& sds, const std::map< std::string, Quantity<real>*>& quantityMap) {
    // update BoundaryCells
